    ...
    <script type="text/javascript">
        ...
        function redirect(){
            ...
            if(num<0){
                ...
                location.href="http://10.0.0.10:8080/index.jsp";
            }
        }
...
<div class="whole">
    <img src="images/sucess_reg.jpg" />
    <div class="mask"></div>
</div>
<div class="b">
    <img src="images/transaction_success.png" width="200" height="200" class="center"/>
    <p>
        亲爱的客户恭喜你<br>
        注册成功<br>
        <span id="num"></span>秒后自动跳转到登录主页
    </p>
</div>
